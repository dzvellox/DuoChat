...
(function runDashboard() {
  ...
  (async () => {
    try {
      ...
      document.getElementById("page").innerHTML = `<article class="card"><h2>DuoChat</h2><p>Le dashboard nécessite un profil DuoChat déverrouillé.</p><a class="primary" style="display:inline-block;text-decoration:none" href="https://chatgpt.com/" target="_blank">Ouvrir ChatGPT</a></article>`;
      console.error(error);
    }
  })();
})();
